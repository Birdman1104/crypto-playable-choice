    ...
    private onStateUpdate(newState): void {
        switch (newState) {
            ...
            case GameState.Wave4:
                this.phone && tweenToCell(this, this.phone, 'phone_show');
                this.moneyBar && tweenToCell(this, this.moneyBar, 'money_bar');
                break;
            ...
            case GameState.Wave3Actions:
                ...
                break;
            case GameState.Fail:
                this.moneyBar && tweenToCell(this, this.moneyBar, 'money_bar_hide');
                this.phone && tweenToCell(this, this.phone, 'phone_hide');
                break;
